...
The source for everything you see here lives on GitHub at [shocklab/nonlinear-dynamics-course](https://github.com/shocklab/nonlinear-dynamics-course). If you spot an error — a broken link, a misattributed citation, a confusing explanation, a wrong sign in an equation — the most useful thing you can do is open an issue or a pull request.
